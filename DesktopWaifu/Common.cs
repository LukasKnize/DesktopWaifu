...
namespace DesktopWaifu {
    internal class Common { //aby vsechno mohlo to accessovat
        static internal FileHistory history = new FileHistory(4, (Program.form.Previous, Program.form.Next)); //do zavorky dejte pocet itemu, ktere tam maxialme muzou byt.
